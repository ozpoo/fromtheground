	...
	<main role="main">
		...
		<section class="container">
			...
			<section class="count-nav">
				<p class="count">
					<?php echo wp_count_posts("workouts")->publish; ?> &mdash;
					<?php $categories = get_categories("taxonomy=workout_category"); ?>
					<select name="cat" id="cat" class="postform">
					<option value="-1">All Workouts</option>
			...
			<?php get_template_part('loop-workouts'); ?>
